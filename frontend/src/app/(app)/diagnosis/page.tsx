...
export default function DiagnosisPage() {
  ...
  if (snap && !prefilled && !result) {
    setForm((prev) => ({
      ...prev,
      annual_revenue: snap.revenue != null ? String(snap.revenue) : "",
      employee_count:
        snap.employee_count != null ? String(snap.employee_count) : "",
    }));
    setPrefilled(true);
  }
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>입력하지 않으면 해당 항목은 0으로 간주됩니다.</CardDescription>
            </CardHeader>
